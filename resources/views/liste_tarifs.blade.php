                        ...
                        <div class="content">
                            ...
                            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                                ...
                                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                                  <!--<a href="<?php echo URL::to('/ajouter-tarifs') ?>">  <button class="btn btn-primary shadow-md mr-2">Ajouter une tarification</button></a>
                    ...
                    <table class="table table-report sm:mt-2">
                        <thead>
                            <tr >
                                ...
                                <th class="whitespace-nowrap">TARIFICATION</th>
                        ...
                        @foreach($result as $value)  
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="w-40">{{$value->montant}} F CFA</td>
                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <a class="flex btn items-center mr-3 tooltip" href="<?php echo URL::to('/modifier-tarifs/'.$value->id) ?>" title='Modifier'> <i style="color:green" data-lucide="edit" class="w-4 h-4 mr-1"></i>  </a>
