            ...
            <div class="wrapper-box">
                ...
                <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0  p-5 mt-5">
                    <table class="table table-report sm:mt-2">
                        <thead>
                            <tr>
                                <th class="whitespace-nowrap">RANG</th>
                        ...
                        <tbody>
                        <?php  if($current==1){ $i = $current;} else { $i = (($current-1)*10)+1; }?>
                        @foreach($result as $value)  

                            <tr class="intro-x">
                                <td class="text-center"><div style="width:40px" class="py-1 px-1 rounded-full text-xs  <?php if($i<=5 && $current==1){ echo "mib";} else {echo "bg-success";} ?> text-white cursor-pointer font-medium" >{{$i++}}</div></td>
                                <td class="w-40">
                                    <div class="flex">
