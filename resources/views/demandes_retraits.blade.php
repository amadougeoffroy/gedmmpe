                    ...
                    <table class="table table-report sm:mt-2">
                        <thead>
                            <tr>
                                ...
                                <th class="whitespace-nowrap">DATE DEMANDE</th>
                        ...
                        <?php 
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="table-report__action w-56">
                                    ...
                                    <a  href="<?php echo URL::to('/traiter-retraits/'.$value->codepaiement) ?>" title="Traiter la demande"><button class="btn mib py-1 px-2 mr-2">Traiter la demande</button></a>
                                    </div>
