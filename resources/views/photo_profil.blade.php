                ...
                <!-- END: Side Menu -->
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="intro-y col-span-12 lg:col-span-12">
                            ...
                            <form action="<?php echo URL::to('/save-photo') ?>" method="post" enctype="multipart/form-data">
                                {{@csrf_field()}}
                                <div class="mt-3 input-form">
                                    <label for="photo" class="form-label">Choisir une photo</label>
                                    <input name="photo"  required id="photo" type="file" class="form-control w-full" >
                                ...
                                <div class="text-right mt-5 ">
                                    ...
                                    <button type="submit" class="btn btn-primary w-30">Changer ma photo de profil</button>
                                </div>
                            </form>
                            </div>
                            <!-- END: Form Layout -->
