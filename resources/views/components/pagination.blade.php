...
<div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
    <nav class="w-full sm:w-auto sm:mr-auto">
        <ul class="pagination">
            ...
            @if(($current-1)>0)
            <li class="page-item"> <a class="page-link" href="<?php echo URL::to($url."/".($current-1)) ?>">{{$current-1}}</a> </li>
            @endif
            <li class="page-item active"> <a class="page-link" href="<?php echo URL::to($url."/".$current) ?>">{{$current}}</a> </li>
